                    ...
                    @foreach ($rooms as $room)
                        <div
                            ...
                            <div class="relative h-48 sm:h-52">
                                ...
                                <div
                                    class="absolute top-0 left-0 {{ $room->status === 'available' ? 'bg-green-500' : ($room->has_available_space ? 'bg-yellow-500' : 'bg-red-500') }} text-white px-2 py-1 m-2 rounded-md text-sm">
                                    <span class="font-medium">{{ $room->status_text }}</span>
                                </div>
