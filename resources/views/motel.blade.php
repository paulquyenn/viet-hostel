<x-tenant-layout>
    <div class="bg-gray-50 min-h-screen pb-10">
        ...
        <div
            class="relative h-[500px] md:h-[600px] overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-800 to-indigo-800">
            ...
            <div class="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
                <div class="text-center w-full max-w-4xl">
                    <!-- Animated heading -->
                    <h1 class="text-white text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                    ...
                    <p class="text-white/90 text-lg md:text-xl mb-8 max-w-2xl mx-auto font-light">
                        Khám phá hàng nghìn lựa chọn phòng trọ chất lượng với giá cả phù hợp nhất
                    </p>
                        ...
                        <form action="{{ route('motel') }}" method="GET">
                                ...
                                <div class="flex flex-col md:flex-row items-center">
                                    <div
                                        ...
                                        <input type="text" name="search"
                                            placeholder="Tìm theo địa chỉ, khu vực hoặc tên phòng trọ..."
                            ...
                            <div class="mt-6 flex flex-wrap justify-center gap-4 text-sm">
                                <a href="{{ route('motel', ['price_to' => 2000000]) }}"
                                    class="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full hover:bg-white/30 transition-all duration-300 flex items-center">
        ...
        <div class="container mx-auto px-4 -mt-16 relative z-20">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-10 border border-gray-100">
                ...
                <form action="{{ route('motel') }}" method="GET" id="filterForm" class="space-y-6">
                    @if (request('search'))
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <select name="province_id" id="province_id"
                                class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 bg-white">
                            ...
                            <div class="relative">
                                <select name="district_id" id="district_id"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 bg-white {{ empty(request('province_id')) ? 'opacity-75 cursor-not-allowed' : '' }}"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="relative">
                                    <input type="number" name="price_from" placeholder="Từ"
                                        ...
                                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200" />
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="relative">
                                    <input type="number" name="area_from" placeholder="Từ"
                                        ...
                                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200" />
                                    <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400">m²
                                    </div>
                                </div>
                                <div class="relative">
                    ...
                    <div
                        ...
                        <div class="mb-4 md:mb-0">
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-2 text-gray-700">Chỉ hiển thị phòng còn trống</span>
                            </label>
                        </div>
                        <div class="flex space-x-3">
                            <a href="{{ route('motel') }}"
                                class="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 flex items-center">
                            ...
                            <button type="submit"
                                class="px-5 py-2.5 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 flex items-center shadow-md">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1.5" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
            ...
            @if ($rooms->count() > 0)
                        ...
                        <div
                            ...
                            <div class="relative h-52">
                                ...
                                <div class="absolute top-0 right-0 bg-indigo-600 text-white px-3 py-1 m-2 rounded-md">
                                    <span class="font-semibold">{{ number_format($room->price) }}/tháng</span>
                                </div>
                                <div
                                    class="absolute top-0 left-0 {{ $room->status == 'Còn trống' ? 'bg-green-500' : 'bg-red-500' }} text-white px-3 py-1 m-2 rounded-md">
                                    <span class="font-semibold">{{ $room->status }}</span>
                                </div>
                            </div>
                            <div class="p-4">
                                <h3 class="font-bold text-lg mb-2 text-gray-800">{{ $room->room_number }}</h3>
                ...
                <div class="mt-8 flex justify-center">
                        ...
                        <div class="flex items-center bg-white px-4 py-2 rounded-lg shadow">
                            ...
                            @else
                                <a href="{{ $rooms->previousPageUrl() }}"
                                    class="px-3 py-1 text-indigo-600 hover:text-indigo-800 transition">
                                    <i class="fas fa-chevron-left"></i> Trước
                                </a>
                            @endif
                            ...
                            <div class="hidden md:flex items-center space-x-1 mx-2">
                                ...
                                @if ($rooms->currentPage() > 3)
                                    <a href="{{ $rooms->url(1) }}"
                                        class="px-3 py-1 rounded-md hover:bg-indigo-50 text-indigo-600">1</a>
                                ...
                                @foreach (range(max(1, $rooms->currentPage() - 2), min($rooms->lastPage(), $rooms->currentPage() + 2)) as $page)
                                    @if ($page == $rooms->currentPage())
                                        <span
                                            class="px-3 py-1 bg-indigo-600 text-white rounded-md">{{ $page }}</span>
                                    @else
                                        <a href="{{ $rooms->url($page) }}"
                                            class="px-3 py-1 rounded-md hover:bg-indigo-50 text-indigo-600">{{ $page }}</a>
                                    @endif
                                @endforeach
                                ...
                                @if ($rooms->currentPage() < $rooms->lastPage() - 2)
                                    ...
                                    <a href="{{ $rooms->url($rooms->lastPage()) }}"
                                        class="px-3 py-1 rounded-md hover:bg-indigo-50 text-indigo-600">{{ $rooms->lastPage() }}</a>
                                @endif
                            </div>

                            <!-- Mobile Pagination Info -->
                            <span class="md:hidden text-gray-600 mx-2">
                    ...
                    <!-- Pagination Info -->
                    <div class="hidden lg:block ml-4 text-sm text-gray-600">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            provinceSelect.addEventListener('change', function() {
                ...
                if (provinceId) {
                    ...
                    // Fetch districts for the selected province - Sửa đường dẫn API
