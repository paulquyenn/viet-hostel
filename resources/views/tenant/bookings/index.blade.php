            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-semibold text-gray-800">Quản lý đặt phòng</h1>
                    </div>
                    ...
                    @if ($bookings->isEmpty())
                        <div class="text-center py-10">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">Không có đơn đặt phòng nào</h3>
                            <p class="mt-1 text-sm text-gray-500">Bạn chưa có đơn đặt phòng nào.</p>
                            <div class="mt-6">
                                <a href="{{ route('motel') }}"
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">{{ $booking->room->building->name }}
                                                </div>
