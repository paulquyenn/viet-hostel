        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-24">
                <div class="text-center mb-16">
                    <span
                        class="inline-block px-3 py-1 text-sm font-medium bg-indigo-100 text-indigo-800 rounded-full mb-4">Đội
                        ngũ</span>
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">Những người dẫn dắt Trọ Việt</h2>
                    <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                        Đội ngũ lãnh đạo giàu kinh nghiệm và đam mê của chúng tôi luôn nỗ lực không ngừng để mang đến
                        dịch vụ tốt nhất
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    <div class="group">
                        <div class="relative overflow-hidden rounded-2xl mb-5">
                            <img class="w-full h-80 object-cover object-center transition-transform duration-500 group-hover:scale-110"
                                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=600&h=800&q=80"
                                alt="CEO">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-indigo-900 opacity-0 group-hover:opacity-70 transition-opacity flex items-end justify-center pb-6">
                        ...
                        <div class="text-center">
                            <h3 class="text-xl font-bold text-gray-900">Nguyễn Văn Quyến</h3>
                            <p class="text-indigo-600 font-medium">Giám đốc điều hành</p>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden rounded-2xl mb-5">
                            <img class="w-full h-80 object-cover object-center transition-transform duration-500 group-hover:scale-110"
                                src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=600&h=800&q=80"
                                alt="CFO">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-indigo-900 opacity-0 group-hover:opacity-70 transition-opacity flex items-end justify-center pb-6">
                                <div class="flex space-x-3 text-white">
                        ...
                        <div class="text-center">
                            <h3 class="text-xl font-bold text-gray-900">Trần Thị B</h3>
                            <p class="text-indigo-600 font-medium">Giám đốc tài chính</p>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden rounded-2xl mb-5">
                            <img class="w-full h-80 object-cover object-center transition-transform duration-500 group-hover:scale-110"
                                src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=600&h=800&q=80"
                                alt="CTO">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-indigo-900 opacity-0 group-hover:opacity-70 transition-opacity flex items-end justify-center pb-6">
                                <div class="flex space-x-3 text-white">
                        ...
                        <div class="text-center">
                            <h3 class="text-xl font-bold text-gray-900">Quyến Paul</h3>
                            <p class="text-indigo-600 font-medium">Giám đốc công nghệ</p>
                        </div>
                    </div>
                    ...
                    <div class="group">
                        <div class="relative overflow-hidden rounded-2xl mb-5">
                            <img class="w-full h-80 object-cover object-center transition-transform duration-500 group-hover:scale-110"
                                src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=600&h=800&q=80"
                        ...
                        <div class="text-center">
                            <h3 class="text-xl font-bold text-gray-900">Phạm Thị D</h3>
                            <p class="text-indigo-600 font-medium">Giám đốc marketing</p>
                        </div>
                    </div>
                </div>
            </div>
